$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
			...
			{ label: '答案1', name: 'option1', index: 'option1', width: 80 },
			{ label: '答案2', name: 'option2', index: 'option2', width: 80 },
			{ label: '答案3', name: 'option3', index: 'option3', width: 80 },
			{ label: '答案4', name: 'option4', index: 'option4', width: 80 }
        ],
		viewrecords: true,
        height: 385,
        rowNum: 10,
